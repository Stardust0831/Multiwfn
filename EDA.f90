...
character(len=80) vmdstructfiles(5)
...
!Output .pqr files
if (ioutatmpqr==1) then
    vmdstructfiles(1)="atmint_tot.pqr"
    vmdstructfiles(2)="atmint_ele.pqr"
    vmdstructfiles(3)="atmint_rep.pqr"
    vmdstructfiles(4)="atmint_disp.pqr"
    vmdstructfiles(5)="atmint_vdW.pqr"
	...
	close(10)
    call maybe_write_vmd_structure_scene_list(vmdstructfiles,5,"pqr")
end if
