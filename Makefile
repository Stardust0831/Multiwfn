...
SMOKE_VMD_EXPORT_PQR ?= $(SMOKE_VMD_DIR)/exported.pqr
SMOKE_VMD_PQR_SCENE ?= $(SMOKE_VMD_EXPORT_PQR).vmd.tcl
SMOKE_VMD_PQR_OUT ?= $(SMOKE_VMD_DIR)/gnu-noGUI-vmd-pqr-smoke.out
SMOKE_VMD_PQR_ERR ?= $(SMOKE_VMD_DIR)/gnu-noGUI-vmd-pqr-smoke.err
...
SMOKE_VMD_GRO_DIR ?= $(SMOKE_DIR)/vmd-gro-export
SMOKE_VMD_EXPORT_GRO ?= $(SMOKE_VMD_GRO_DIR)/exported.gro
SMOKE_VMD_GRO_SCENE ?= $(SMOKE_VMD_EXPORT_GRO).vmd.tcl
SMOKE_VMD_GRO_OUT ?= $(SMOKE_VMD_GRO_DIR)/gnu-noGUI-vmd-gro-smoke.out
SMOKE_VMD_GRO_ERR ?= $(SMOKE_VMD_GRO_DIR)/gnu-noGUI-vmd-gro-smoke.err
...
gnu-noGUI-smoke: gnu-noGUI
	...
	SMOKE_VMD_EXPORT_PQR="$(SMOKE_VMD_EXPORT_PQR)" \
	SMOKE_VMD_PQR_SCENE="$(SMOKE_VMD_PQR_SCENE)" \
	SMOKE_VMD_PQR_OUT="$(SMOKE_VMD_PQR_OUT)" \
	SMOKE_VMD_PQR_ERR="$(SMOKE_VMD_PQR_ERR)" \
	...
	SMOKE_VMD_GRO_DIR="$(SMOKE_VMD_GRO_DIR)" \
	SMOKE_VMD_EXPORT_GRO="$(SMOKE_VMD_EXPORT_GRO)" \
	SMOKE_VMD_GRO_SCENE="$(SMOKE_VMD_GRO_SCENE)" \
	SMOKE_VMD_GRO_OUT="$(SMOKE_VMD_GRO_OUT)" \
	SMOKE_VMD_GRO_ERR="$(SMOKE_VMD_GRO_ERR)" \
	tools/gnu-nogui-smoke.sh

gnu-clean:
	$(MAKE) clean
	rm -rf "$(GNU_MOD_DIR)" "$(GNU_OBJ_DIR)" "$(SMOKE_DIR)" .build-env/nogui-build-audit.* .build-env/gnu-smoke-stderr-audit-smoke.* .build-env/vmd-bridge-smoke.* .build-env/vmd-doctor-smoke.* .build-env/vmd-open-scene-smoke.*
