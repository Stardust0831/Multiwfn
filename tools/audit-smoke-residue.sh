...
check_smoke_export_residue() {
    export_residue=0
    for file in he_minimal.chg atmpopdcp.txt density.cub density.cub.vmd.tcl CHGCAR CHGCAR.vmd.tcl POSCAR POSCAR.vmd.tcl exported.pdb exported.pdb.vmd.tcl exported.pqr exported.pqr.vmd.tcl exported.gro exported.gro.vmd.tcl exported.molden exported.molden.vmd.tcl exported.CHGCAR exported.CHGCAR.vmd.tcl exported.POSCAR exported.POSCAR.vmd.tcl
    do
