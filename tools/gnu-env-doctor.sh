...
print_tool "Fortran compiler" "$gnu_prefix/bin/x86_64-conda-linux-gnu-gfortran"
print_tool "C compiler" "$gnu_prefix/bin/x86_64-conda-linux-gnu-gcc"
print_tool "make" "$gnu_prefix/bin/make"

if [ -r "$gnu_prefix/lib/libopenblas.so" ] || [ -r "$gnu_prefix/lib/libopenblas.a" ]; then
